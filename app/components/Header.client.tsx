...
shadow flex justify-between items-center px-6 py-4"> 
      <Link href="/"> 
        <div className="text-xl font-bold 
tracking-tight">Product Catalog</div> 
      </Link> 
      <div className="relative"> 
        <button 
          className="flex items-center gap-2 px-4 py-2 
rounded-md bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 
...
py-2 hover:bg-gray-100 dark:hover:bg-gray-700" 
